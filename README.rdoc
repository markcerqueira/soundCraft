...
* *nime-paper.tex* - short paper submission for LOrkCraft for NIME 2013
* *nime-performance.tex* - performance submission for LOrkCraft for NIME 2013
...
If *PRINT_DATA* is defined in *bank_parser.rb*, data for each OSC message sent will be printed out. The print statements include the time in seconds since the program started running, OSC address, tags, and content sent. A blank line will be printed after an entire XML bank has been parsed. Debug print statements be disabled for live performances, but can be useful while developing. Here is some sample output for reference:
    5.257: /lorkCraft/mineralBank.SC2Bank (si): total_minerals_collected, 160
    5.257: /lorkCraft/mineralBank.SC2Bank (si): current_mineral_count, 240

    6.412: /lorkCraft/unitsBuiltBank.SC2Bank (si): Nexus, 1
    6.412: /lorkCraft/unitsBuiltBank.SC2Bank (si): Probe, 8

    8.928: /lorkCraft/scoreBank.SC2Bank (si): idle_production_time, 16
    8.928: /lorkCraft/scoreBank.SC2Bank (si): vespene_collection_rate, 0
    8.928: /lorkCraft/scoreBank.SC2Bank (si): enemy_structures_razed, 0
    8.929: /lorkCraft/scoreBank.SC2Bank (si): mineral_collection_rate, 280
    8.929: /lorkCraft/scoreBank.SC2Bank (si): resource_lost_all, 0
    8.929: /lorkCraft/scoreBank.SC2Bank (si): total_resource_value_of_army, 0
    8.930: /lorkCraft/scoreBank.SC2Bank (si): total_overview_score, 960
    8.930: /lorkCraft/scoreBank.SC2Bank (si): workers_trained, 8
    8.930: /lorkCraft/scoreBank.SC2Bank (si): enemy_units_killed, 0
    8.930: /lorkCraft/scoreBank.SC2Bank (si): player_apm, 24
    8.931: /lorkCraft/scoreBank.SC2Bank (si): average_minerals_stockpiled, 44
    8.931: /lorkCraft/scoreBank.SC2Bank (si): workers_lost, 0

    9.010: /lorkCraft/infoBank.SC2Bank (ss): player_race, Race/Name/Prot
    9.010: /lorkCraft/infoBank.SC2Bank (ss): player_handle, marktronic
    9.010: /lorkCraft/infoBank.SC2Bank (sf): elapsed_time, 60

    9.236: /lorkCraft/productionBank.SC2Bank (sf): 1-Marine, 95.0195
    9.236: /lorkCraft/productionBank.SC2Bank (sf): 0-SCV, 72.0703
    9.237: /lorkCraft/productionBank.SC2Bank (sf): 2-Marine, 95.752

    9.419: /lorkCraft/cameraBank.SC2Bank (sf): cameraFocusX, 76.5
    9.419: /lorkCraft/cameraBank.SC2Bank (sf): cameraFocusY, 9.7617

    9.583: /lorkCraft/productionBank.SC2Bank (sf): 0-SCV, 83.838

    9.947: /lorkCraft/productionBank.SC2Bank (sf): no_production, 0.0
...
* Write out unit production status every second (a special *no_production* message is sent when no units are being produced)
