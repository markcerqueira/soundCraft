...
If *PRINT_DATA* is defined in *bank_parser.rb*, data for each OSC message sent will be printed out. The print statements include the address, tags, and content sent. A blank line will be printed after an entire XML bank has been parsed. This should be disabled for live performances, but should be useful while developing. Here is some sample output for reference:
    ...
    /lorkCraft/infoBank.SC2Bank (ss): player_race, Race/Name/Prot
    /lorkCraft/infoBank.SC2Bank (ss): player_handle, marktronic
    /lorkCraft/infoBank.SC2Bank (ss): elapsed_time, 60

    /lorkCraft/cameraBank.SC2Bank (ss): cameraFocusX, 76.5
    /lorkCraft/cameraBank.SC2Bank (ss): cameraFocusY, 9.7617
