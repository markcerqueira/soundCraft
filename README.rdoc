...
* When a unit/building is built write out current army/building composition
...
* Add support to the custom map to collect:
  ...
  * When a unit/building dies write out write out current army/building composition
